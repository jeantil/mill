...
- configures mill for Play Framework default directory layout,
- integrates the Play framework routes compiler,
- optionally: integrates the Twirl template engine,
- optionally: configure mill for single module play applications.
...
command to get a runnable fat jar of the project. The packaging is slightly different though.
